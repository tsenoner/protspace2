    ...
    >
      ...
      <Container maxW="container.md" py={5}>
        ...
        <Text fontSize="lg" mb={2}>
          Welcome to the guideline page. Here you&apos;ll find detailed information about ProtSpace.
        </Text>
        ...
        <Text fontSize="md" mb={2}>
          The application interface includes several interactive controls designed to enhance your
          experience:
        </Text>
        ...
        <Flex direction="column" gap="4" mb="4">
          <Flex align="center">
            ...
            <Text>
              <strong>Toggle Controller:</strong> Toggle the visibility of the control menu.
            </Text>
          </Flex>
          <Flex align="center">
            {colorMode === 'light' ? (
            ...
            <Text>
              <strong>Dark/Light Mode Toggle:</strong> Switch between dark and light mode.
            </Text>
          </Flex>
          <Flex align="center">
            <BsFiletypePng className="h-6 w-6 text-yellow-600 mr-2" />
            <Text>
              <strong>Download Plot:</strong> Save the current plot as a PNG file.
            </Text>
          </Flex>
          <Flex align="center">
            <BsFiletypeSvg className="h-6 w-6 text-blue-200 mr-2" />
            <Text>
              <strong>Download as SVG:</strong> Export the visualization in SVG format.
            </Text>
          </Flex>
          <Flex align="center">
            <MapIcon className="h-6 w-6 text-green-500 mr-2" />
            <Text>
              <strong>Show/Hide Legend:</strong> Control the display of the legend.
            </Text>
          </Flex>
          <Flex align="center">
            <DocumentArrowDownIcon className="h-6 w-6 text-pink-500 mr-2" />
            <Text>
              <strong>Export Project:</strong> Export the current project&apos;s state as a JSON
              file.
            </Text>
          </Flex>
          <Flex align="center">
            ...
            <Text>
              <strong>Import Project:</strong> Import a project from a JSON file.
            </Text>
          </Flex>
          <Flex align="center">
        ...
        <Text fontSize="md" mb={2}>
          Ensure your JSON file matches the following structure to be compatible with the
          application:
        </Text>
        <pre
          style={{
