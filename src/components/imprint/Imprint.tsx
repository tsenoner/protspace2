    ...
    >
      ...
      <Container maxW="container.md" py={5}>
        ...
        <Text fontSize="lg" mt={4} mb={2}>
          ...
          <br />
          Technical University of Munich is a statutory body under public law (Art. 11 Abs. 1
          BayHSchG). It is legally represented by the President, Prof. Dr. Thomas F. Hofmann.
        </Text>

        <Text fontSize="lg" mt={4} mb={2}>
          <strong>Supervisory Authority:</strong>
          <br />
          Bavarian State Ministry of Science and the Arts (Bayerisches Staatsministerium für
        ...
        <Text fontSize="lg" mt={4} mb={2}>
          ...
          <br />
          In spite of regularily monitoring the linked resources with great care, we do not accept
          any responsibility for the content of external links. The operators of these websites are
